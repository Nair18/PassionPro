...
export default class StatsPageTrainer extends Component {
  constructor(props){
    super(props)
    this.state = {
  ...
  render(){
    ...
    console.log("end date printing ", this.state.end_date)
            ...
            <View>
                ...
                <View style={styles.cardListView}>
                   <TouchableOpacity activeOpacity={1}>
                     <Card>
                        <CardItem header style={{backgroundColor: '#f4f4f4', height: 80}}>
                            <Text>Total money paid to Trainer as <Text style={{fontWeight: 'bold', color: constants.text_highlight}}>Salary</Text></Text>
                        </CardItem>
                        <CardItem style={{justifyContent: 'center', alignItems: 'center', backgroundColor: constants.card_body}}>
                            <Text style={{fontWeight: 'bold', fontSize: 30}}>{'₹'}<Text style={{fontSize: 50,color: constants.red_money}}>{this.state.stats["trainer_salaries"] === null ? 0 : this.state.stats["trainer_salaries"]}</Text></Text>
                        </CardItem>
